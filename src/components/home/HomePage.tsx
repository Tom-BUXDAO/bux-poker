...
export default function HomePage() {
  return (
    <>
      ...
      <main className="h-screen bg-gray-900 text-white grid grid-rows-[10vh_40vh_25vh_15vh_10vh] max-h-screen overflow-hidden portrait:hidden">
        {/* Header - 10vh */}
        <header className="border-b border-gray-800">
          <div className="container mx-auto px-2 h-full flex justify-between items-center">
            <Link href="/" className="flex items-center gap-1">
              <Image src="/BUX.png" alt="BUX Logo" width={24} height={24} className="rounded-full" />
              <span className="text-base font-bold bg-gradient-to-r from-green-400 to-yellow-400 bg-clip-text text-transparent">
                BUX POKER HUB
              </span>
            </Link>
            <button
              onClick={() => signIn('discord')}
              className="flex items-center gap-1 bg-[#5865F2] hover:bg-[#4752C4] transition-colors px-3 py-1 rounded text-sm"
            >
        ...
        <div className="container mx-auto px-2">
          <div className="grid grid-cols-3 gap-2 h-full py-2">
            <Link href="/tournament/dev-tournament" className="group">
              <div className="bg-gray-800 rounded p-2 border border-gray-700 hover:border-green-500 transition-all h-full">
                <h3 className="text-sm font-bold text-green-400">Dev-test Tournament</h3>
                <p className="text-xs text-gray-400 leading-tight">Test and practice your poker skills.</p>
              </div>
            </Link>
            <Link href="/sit-n-go" className="group">
              <div className="bg-gray-800 rounded p-2 border border-gray-700 hover:border-yellow-500 transition-all h-full">
                <h3 className="text-sm font-bold text-yellow-400">Sit n' Goes</h3>
                <p className="text-xs text-gray-400 leading-tight">Quick games that start as soon as enough players join.</p>
              </div>
            </Link>
            <Link href="/tournaments" className="group">
              <div className="bg-gray-800 rounded p-2 border border-gray-700 hover:border-blue-500 transition-all h-full">
                <h3 className="text-sm font-bold text-blue-400">Tournaments</h3>
                <p className="text-xs text-gray-400 leading-tight">Compete in scheduled tournaments.</p>
              </div>
            </Link>
          </div>
        </div>
        ...
        {/* Features - 15vh */}
        <div className="container mx-auto px-2">
          <h2 className="text-base font-bold text-white text-center mb-1">Features</h2>
          <div className="grid grid-cols-3 gap-2 h-[calc(100%-2rem)]">
            <div className="bg-gray-800/50 rounded p-2 h-full">
              <div className="flex items-center gap-1.5">
                <svg className="w-3.5 h-3.5 text-green-400" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515a.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0a12.64 12.64 0 0 0-.617-1.25a.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057a19.9 19.9 0 0 0 5.993 3.03a.078.078 0 0 0 .084-.028a14.09 14.09 0 0 0 1.226-1.994a.076.076 0 0 0-.041-.106a13.107 13.107 0 0 1-1.872-.892a.077.077 0 0 1-.008-.128a10.2 10.2 0 0 0 .372-.292a.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127a12.299 12.299 0 0 1-1.873.892a.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028a19.839 19.839 0 0 0 6.002-3.03a.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03z"/>
                </svg>
                <h3 className="text-sm font-bold text-green-400">Discord Profile</h3>
              </div>
              <p className="text-xs text-gray-400 leading-tight mt-1">Seamlessly integrate your Discord identity.</p>
            </div>
            <div className="bg-gray-800/50 rounded p-2 h-full">
              <div className="flex items-center gap-1.5">
                ...
                <h3 className="text-sm font-bold text-yellow-400">Easy Join</h3>
              </div>
              <p className="text-xs text-gray-400 leading-tight mt-1">Register with a simple "JOIN" button.</p>
            </div>
            <div className="bg-gray-800/50 rounded p-2 h-full">
              <div className="flex items-center gap-1.5">
                ...
                <h3 className="text-sm font-bold text-blue-400">Leaderboard <span className="text-xs text-blue-400/70">Soon</span></h3>
              </div>
              <p className="text-xs text-gray-400 leading-tight mt-1">Win monthly prizes based on standings.</p>
            </div>
          </div>
        </div>
